...
public class az extends RealmsScreen {
   ...
   public az(RealmsScreen lastScreen, b mainScreen, RealmsServer realmsServer) {
      this.b = lastScreen;
      this.c = mainScreen;
      this.d = realmsServer;
   }
   ...
   private void a() {
      ...
      try {
         client.l();
         al longRunningMcoTaskScreen = new al(this.b, new bi.e(this.c, this.b, this.d, new ReentrantLock()));
   ...
   public boolean mouseClicked(double x, double y, int buttonNum) {
      if (this.f) {
         ...
         bk.c("https://minecraft.net/realms/terms");
         return true;
      } else {

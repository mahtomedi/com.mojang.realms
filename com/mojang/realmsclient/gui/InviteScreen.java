...
public class InviteScreen extends RealmsScreen {
   ...
   public InviteScreen(RealmsScreen onlineScreen, ConfigureWorldScreen configureScreen, McoServer serverData) {
   ...
   public void init() {
      ...
      this.profileName = this.newEditBox(this.width() / 2 - 100, 66, 200, 20);
   ...
   public void buttonClicked(RealmsButton button) {
      if (button.active()) {
         if (button.id() == 1) {
            ...
            try {
               McoServer mcoServer = client.invite(this.serverData.id, this.profileName.getValue());
               if (mcoServer != null) {
                  this.serverData.players = mcoServer.players;

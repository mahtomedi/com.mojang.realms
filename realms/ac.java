...
public class ac extends as<WorldTemplate> implements w.b {
   ...
   public ac(b lastScreen, long serverId) {
      this.c = lastScreen;
      this.e = serverId;
   }
   ...
   public void init() {
      ...
      this.buttonsAdd(this.j = new RealmsButton(2, this.a(0, 3), u.a(0), 100, 20, getLocalizedString("mco.configure.world.buttons.players")) {
         public void onPress() {
            Realms.setScreen(new ao(ac.this, ac.this.d));
         }
      });
      this.buttonsAdd(this.k = new RealmsButton(3, this.a(1, 3), u.a(0), 100, 20, getLocalizedString("mco.configure.world.buttons.settings")) {
         public void onPress() {
            Realms.setScreen(new av(ac.this, ac.this.d.clone()));
         }
      });
      this.buttonsAdd(this.l = new RealmsButton(4, this.a(2, 3), u.a(0), 100, 20, getLocalizedString("mco.configure.world.buttons.subscription")) {
         public void onPress() {
            Realms.setScreen(new ax(ac.this, ac.this.d.clone(), ac.this.c));
         }
      });
      ...
      this.buttonsAdd(this.p = new RealmsButton(8, this.b(0), u.a(13) - 5, 100, 20, getLocalizedString("mco.configure.world.buttons.switchminigame")) {
         public void onPress() {
            au minigameScreen = new au(ac.this, null, RealmsServer.c.b);
      ...
      this.buttonsAdd(
         this.m = new RealmsButton(5, this.b(0), u.a(13) - 5, 90, 20, getLocalizedString("mco.configure.world.buttons.options")) {
            public void onPress() {
               Realms.setScreen(
                  new aw(ac.this, ((RealmsWorldOptions)ac.this.d.slots.get(ac.this.d.activeSlot)).clone(), ac.this.d.worldType, ac.this.d.activeSlot)
               );
            }
         }
      );
      this.buttonsAdd(this.n = new RealmsButton(6, this.b(1), u.a(13) - 5, 90, 20, getLocalizedString("mco.configure.world.backup")) {
         public void onPress() {
            Realms.setScreen(new z(ac.this, ac.this.d.clone(), ac.this.d.activeSlot));
         }
      });
      this.buttonsAdd(this.o = new RealmsButton(7, this.b(2), u.a(13) - 5, 90, 20, getLocalizedString("mco.configure.world.buttons.resetworld")) {
         public void onPress() {
            Realms.setScreen(new aq(ac.this, ac.this.d.clone(), ac.this.b()));
         }
      });
      ...
      (new Thread() {
         public void run() {
            ...
            try {
               ...
               ac.a.error("Couldn't get own world");
               Realms.setScreen(new ah(var3.getMessage(), ac.this.c));
            } catch (IOException var4) {
               ac.a.error("Couldn't parse response getting own world");
            }
   ...
   private void a(RealmsServer serverData) {
      if (this.d.state == RealmsServer.b.b) {
         this.c.a(serverData, new ac(this.c.f(), this.e));
      } else {
         this.a(true, new ac(this.c.f(), this.e));
      }
   ...
   private void f() {
      au screen = new au(this, null, RealmsServer.c.b);
   ...
   private void a(int selectedSlot, RealmsServer serverData) {
      ...
      Realms.setScreen(new aj((result, id) -> {
         if (result) {
   ...
   public void a(RealmsWorldOptions options) {
      ...
      try {
         ...
         Realms.setScreen(new ah(var5, this));
         return;
   ...
   public void a(String name, String desc) {
      ...
      try {
         ...
         Realms.setScreen(new ah(var6, this));
         return;
   ...
   public void a(boolean join, RealmsScreen screenInCaseOfCancel) {
      bh.c openServerTask = new bh.c(this.d, this, this.c, join);
      ak openWorldLongRunningTaskScreen = new ak(screenInCaseOfCancel, openServerTask);
   ...
   public void a(RealmsScreen screenInCaseOfCancel) {
      bh.a closeServerTask = new bh.a(this.d, this);
      ak closeWorldLongRunningTaskScreen = new ak(screenInCaseOfCancel, closeServerTask);
   ...
   private void a(long worldId, int selectedSlot) {
      ac newScreen = this.b();
      bh.i switchSlotTask = new bh.i(worldId, selectedSlot, (result, id) -> Realms.setScreen(newScreen), 11);
   ...
   private void b(WorldTemplate selectedWorldTemplate) {
      bh.h startMinigameTask = new bh.h(this.d.id, selectedWorldTemplate, this.b());
      ak longRunningMcoTaskScreen = new ak(this.c, startMinigameTask);
      longRunningMcoTaskScreen.a();
      Realms.setScreen(longRunningMcoTaskScreen);
   }

   public ac b() {
      return new ac(this.c, this.e);
   }
}

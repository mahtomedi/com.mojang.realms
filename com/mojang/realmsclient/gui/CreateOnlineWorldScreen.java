...
public class CreateOnlineWorldScreen extends ScreenWithCallback<WorldTemplate> {
   ...
   private void createWorld() {
      if (this.valid()) {
         CreateOnlineWorldScreen.WorldCreationTask worldCreationTask = new CreateOnlineWorldScreen.WorldCreationTask(
   ...
   class WorldCreationTask extends LongRunningTask {
      ...
      public void run() {
         ...
         try {
            ...
            Realms.setScreen(CreateOnlineWorldScreen.this.lastScreen);
         } catch (RealmsServiceException var4) {
            CreateOnlineWorldScreen.LOGGER.error("Couldn't create world");
            this.error(var4.toString());
         } catch (UnsupportedEncodingException var5) {
            CreateOnlineWorldScreen.LOGGER.error("Couldn't create world");
            this.error(var5.getLocalizedMessage());
         } catch (IOException var6) {
            CreateOnlineWorldScreen.LOGGER.error("Could not parse response creating world");
            this.error(var6.getLocalizedMessage());
         } catch (Exception var7) {
            CreateOnlineWorldScreen.LOGGER.error("Could not create world");

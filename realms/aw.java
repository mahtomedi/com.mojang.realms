...
public class aw extends RealmsScreen {
   ...
   public aw(ad configureWorldScreen, RealmsServer serverData) {
   ...
   public void init() {
      ...
      this.buttonsAdd(
         new RealmsButton(
            ...
            public void onPress() {
               if (aw.this.b.state.equals(RealmsServer.b.b)) {
                  ...
                  Realms.setScreen(new ak(aw.this, ak.a.b, line2, line3, true, 5));
               } else {
                  aw.this.a.a(false, aw.this);
               }

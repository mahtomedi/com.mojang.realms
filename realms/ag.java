...
public class ag extends RealmsScreen {
   ...
   private void a() {
      if (this.b()) {
         bi.j trialCreationTask = new bi.j(this.b.getValue(), this.c.getValue(), this.a);
         al longRunningMcoTaskScreen = new al(this.a, trialCreationTask);

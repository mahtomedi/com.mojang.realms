...
public class bi {
   private static final Map<String, bi.a> a = new HashMap();
   ...
   private static void a(final String uuid) {
      ...
      if (a.containsKey(uuid)) {
         GlStateManager.bindTexture(((bi.a)a.get(uuid)).b);
         ...
         Thread thread = new Thread("Realms Texture Downloader") {
            public void run() {
               Map<Type, MinecraftProfileTexture> fetchedTextures = bj.b(uuid);
               if (fetchedTextures.containsKey(Type.SKIN)) {
                  ...
                  bi.d.debug("Downloading http texture from {}", url);
                  ...
                  try {
                     ...
                     if (connection.getResponseCode() / 100 == 2) {
                        ...
                        loadedImage = new bk().a(loadedImage);
                        ByteArrayOutputStream output = new ByteArrayOutputStream();
                        ImageIO.write(loadedImage, "png", output);
                        bi.c.put(uuid, DatatypeConverter.printBase64Binary(output.toByteArray()));
                        bi.b.put(uuid, true);
                        return;
                     }
                     ...
                     bi.d.error("Couldn't download http texture", var19);
                     bi.b.remove(uuid);
                     return;
                  } finally {
                     if (connection != null) {
   ...
   private static int b(String id, String image) {
      ...
      a.put(id, new bi.a(image, textureId));
      return textureId;
   }

...
public class OnlineConnectTask extends LongRunningTask {
   private static final Logger LOGGER = LogManager.getLogger();
   private final RealmsConnect realmsConnect;
   private final McoServer data;
   private final RealmsScreen onlineScreen;

   public OnlineConnectTask(RealmsScreen onlineScreen, McoServer server) {

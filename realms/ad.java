...
public class ad extends RealmsScreen {
   ...
   public ad(RealmsScreen parent, String title1, String title2, int id) {
      this.a = parent;
      this.b = title1;
      this.f = title2;
      this.e = id;
   ...
   public ad(RealmsScreen parent, String title1, String title2, String yesButton, String noButton, int id) {
      this.a = parent;
      this.b = title1;
      this.f = title2;
      this.c = yesButton;
   ...
   public void init() {
      this.buttonsAdd(new RealmsButton(0, this.width() / 2 - 105, u.a(9), 100, 20, this.c) {
         public void onPress() {
            ad.this.a.confirmResult(true, ad.this.e);
         }
      });
      this.buttonsAdd(new RealmsButton(1, this.width() / 2 + 5, u.a(9), 100, 20, this.d) {
         public void onPress() {
            ad.this.a.confirmResult(false, ad.this.e);
         }
      });
   }

...
public class aa extends RealmsScreen {
   ...
   public aa(RealmsScreen lastScreen, realms.b mainScreen, long serverId) {
      this.b = lastScreen;
      this.c = mainScreen;
      this.e = serverId;
   }
   ...
   public void a() {
      for(Entry<Integer, RealmsWorldOptions> entry : this.d.slots.entrySet()) {
         ...
         if (canPlay) {
            downloadButton = new aa.b(l.get(entry.getKey() - 1), this.a(entry.getKey()), getLocalizedString("mco.brokenworld.play"));
         } else {
            downloadButton = new aa.a(n.get(entry.getKey() - 1), this.a(entry.getKey()), getLocalizedString("mco.brokenworld.download"));
         }
         ...
         this.buttonsAdd(new RealmsButton(m.get(entry.getKey() - 1), this.a(entry.getKey()), u.a(10), 80, 20, getLocalizedString("mco.brokenworld.reset")) {
            public void onPress() {
               int slot = aa.m.indexOf(this.id()) + 1;
               aq realmsResetWorldScreen = new aq(aa.this, aa.this.d, aa.this);
               if (slot != aa.this.d.activeSlot || aa.this.d.worldType.equals(RealmsServer.c.b)) {
   ...
   private void a(final long worldId) {
      (new Thread() {
         public void run() {
            ...
            try {
               aa.this.d = client.a(worldId);
               aa.this.a();
            } catch (o var3) {
               aa.a.error("Couldn't get own world");
               Realms.setScreen(new ah(var3.getMessage(), aa.this.b));
            } catch (IOException var4) {
               aa.a.error("Couldn't parse response getting own world");
            }
      ...
      if (!result) {
         ...
         if (id != 13 && id != 14) {
            ...
            (new Thread() {
               public void run() {
                  g client = realms.g.a();
                  if (aa.this.d.state.equals(RealmsServer.b.a)) {
                     bh.c openServerTask = new bh.c(aa.this.d, aa.this, aa.this.b, true);
                     ak openWorldLongRunningTaskScreen = new ak(aa.this, openServerTask);
                     openWorldLongRunningTaskScreen.a();
                     Realms.setScreen(openWorldLongRunningTaskScreen);
                  } else {
                     try {
                        aa.this.c.f().a(client.a(aa.this.e), aa.this);
                     } catch (o var4) {
                        aa.a.error("Couldn't get own world");
                        Realms.setScreen(aa.this.b);
   ...
   private void b(int slotId) {
      ...
      try {
         ...
         ag downloadScreen = new ag(this, worldDownload, this.d.name + " (" + ((RealmsWorldOptions)this.d.slots.get(slotId)).getSlotName(slotId) + ")");
   ...
   private void a(int x, int y, int xm, int ym, boolean active, String text, int i, long imageId, String image, boolean empty) {
      if (empty) {
         ...
         bi.a(String.valueOf(this.d.minigameId), this.d.minigameImage);
      }
   ...
   private void c(int id) {
      bh.i switchSlotTask = new bh.i(this.d.id, id, this, 13);
      ak longRunningMcoTaskScreen = new ak(this.b, switchSlotTask);
   ...
   class a extends RealmsButton {
      ...
      public void onPress() {
         ...
         Realms.setScreen(new aj(aa.this, aj.a.b, line2, line3, true, this.id()));
      }
   }
   ...
   class b extends RealmsButton {
      ...
      public void onPress() {
         int slot = aa.l.indexOf(this.id()) + 1;
         if (((RealmsWorldOptions)aa.this.d.slots.get(slot)).empty) {
